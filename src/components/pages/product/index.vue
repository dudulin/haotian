<template>
  <div id="product">
    ...
    <div class="content">
      ...
      <div style="width: 100%;overflow: hidden;" :style="activeMenu === 3 ? 'background:rgba(255,255,255,1);' : 'background:rgba(248,248,248,1);'">
        <div class="breadcrumb" :style="activeMenu === 3 ? 'background:rgba(255,255,255,1);' : 'background:rgba(248,248,248,1);'">
